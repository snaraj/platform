# Release-selector compatibility procedures

The procedures below apply to historical tag-selected sources. Current
application delivery uses protected-main reconciliation; restoring a historical
selector is a separate recovery decision.
...
annotated `v0.1.43` Release. Burned `v0.1.41` and `v0.1.42` are never selected.
Recovery after the source advances requires a clean checkout of the exact canonical annotated

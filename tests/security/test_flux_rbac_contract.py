...
``testsupport/rbac_model.py``. Live authorization and controller health require fresh operational evidence.
"""
...
class FluxRbacCompositionTests(unittest.TestCase):
    """The RBAC model and the rendered manifests must agree."""

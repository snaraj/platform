...
class PlatformReleaseIdentityAssetTests(unittest.TestCase):
    ...
    def test_receipt_derives_exact_current_site_identities(self) -> None:
        ...
        self.assertEqual(
            ...
            {
                "layer_digest": (
                    "sha256:c9a3ee1272562dd7ab38d3ab"
                    "834e491f8c689a799ee33eec5"
                    "6fa3fc9937ebe7f"
                ),
                "manifest_digest": (
                    "sha256:a665c74985b0dc3e9b8351c0"
                    "306d58f8d318a581f7fdda718"
                    "74a98fde85773f3"
                ),
        ...
        self.assertEqual(
            ...
            {
                "arm64_digest": (
                    "sha256:6e3c2d23ad04a61aa22d3c12"
                    "3802922c4d1360e8ca10c063"
                    "5fe3511ad94ac786"
                ),
                "image": (
                    "ghcr.io/snaraj/naranjo-online:v0.1.80@"
                    "sha256:63236d492c84e7d0e48f3e8"
                    "b8c1b7551053defbd6461e27"
                    "a3b3e6e5c1559f05f"
                ),
            },
        )

...
Two validators read owner-private files (tunnel token and kubeconfig snapshot) through a private copy of the same
...
be byte-identical to the canonical carrier's. An additional tracked copy (or a
